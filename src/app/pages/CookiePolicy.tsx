  ...
  return (
    <div className="py-20 md:py-28 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl md:text-5xl text-slate-900 mb-6">Cookie Policy</h1>
        <p className="text-slate-500 mb-12">Last updated: December 17, 2025</p>

        <div className="prose prose-slate max-w-none space-y-8">
          <section>
            <h2 className="text-2xl text-slate-900 mb-4">What Are Cookies</h2>
          ...
          <section>
            <h2 className="text-2xl text-slate-900 mb-4">How We Use Cookies</h2>
          ...
          <section>
            <h2 className="text-2xl text-slate-900 mb-4">Types of Cookies We Use</h2>
            
            <div className="space-y-6">
              <div>
                <h3 className="text-xl text-slate-900 mb-2">Session Cookies</h3>
                <p className="text-slate-600 leading-relaxed">
                  These cookies are temporary and expire when you close your browser. They help us maintain 
                  your session as you navigate through our website.
                </p>
              </div>

              <div>
                <h3 className="text-xl text-slate-900 mb-2">Persistent Cookies</h3>
                <p className="text-slate-600 leading-relaxed">
                  These cookies remain on your device for a set period or until you delete them. They help us 
                  remember your preferences and recognize you when you return to our website.
                </p>
              </div>

              <div>
                <h3 className="text-xl text-slate-900 mb-2">Third-Party Cookies</h3>
                <p className="text-slate-600 leading-relaxed">
                  We may use third-party services (such as Google Analytics) that place cookies on your device 
                  to help us analyze website traffic and usage.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-2xl text-slate-900 mb-4">Managing Cookies</h2>
            <p className="text-slate-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl text-slate-900 mb-4">Cookie Consent</h2>
            <p className="text-slate-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl text-slate-900 mb-4">Updates to This Policy</h2>
            <p className="text-slate-600 leading-relaxed">
